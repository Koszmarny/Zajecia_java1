...
public class SCTest {
    public static void main(String[] args) {
        ...
        int g = 41, h = 92, i = 20, j = 3, k = 7, l = 8;
...
//        System.out.println(SimpleCalculations.fibonacci(20));
//        System.out.println(SimpleCalculations.factorial(21));
        System.out.println(SimpleCalculations.product(1000000, 10000000));
